...
\eqref{eqn:point_r}, are still well-defined: they only uses simple arithmetic
...
positive integers. Same holds for `point1`: by adding it repeatedly we generate
...
Finally, we compute Keccak-256 hash on the public point, and take last 40
characters:
...
# Appendix
<details><summary>ALL CODE</summary><p>
{% highlight python %}
